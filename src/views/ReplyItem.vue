...
export default {
  ...
  moment,
    upvoteReply() {
  axios.put('https://salty-inlet-98667.herokuapp.com/api/comments/vote/' + this.reply.id, {
  ...
  downVoteReply() {
    axios.put('https://salty-inlet-98667.herokuapp.com/api/comments/downvote/' + this.reply.id, {
      apiKey: localStorage.getItem('apiToken')
    })
    .then(response => {
      console.log(response.data);
